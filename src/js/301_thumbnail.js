 ...
 * Last modified  : 2018-06-02 14:42:32
 */

import React from 'react';

const ServiceThumbnail = ({ svcName, svcImage }) => {
    return (
        <div key={svcName} className="col-sm-6 col-md-3">
            <div className="card cart-block">
                <div>
                    <img id="card-img-top1" className="card-img-top" src={svcImage} />
                </div>
